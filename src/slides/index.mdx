...
# Building Accessible<br />Sites with Gatsby
...
- “Hydration” into React.js apps
- Automatic client-side routing
- Perfect for modern test tooling
...
- Includes these MDX-Deck slides
...
gatsby new gatsby-workshop https://github.com/marcysutton/gatsby-a11y-workshop.git
cd gatsby-workshop
...
Online: https://marcysutton.github.io/gatsby-a11y-workshop

</Slide>

---

<img src="../vscode-tour.png" alt="Project in VS Code" style="max-height: 100vh" />
...
- [more](http://marcysutton.github.io/gatsby-a11y-workshop#Testing-Tools)
...
<br />
<a href="https://www.gatsbyjs.org/docs/building-with-components/">Building with components</a>
...
# Functional components in action
...
# Accessibility in JavaScript Applications (& Gatsby sites)
...
- Component shell: [dropdown.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/components/better/dropdown.js)
...
- [examples/dropdown](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/examples/dropdown/)
...
- [live-region](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/src/components/better/live-region.js)
...
- [examples/live-region](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/examples/live-region)
...
- Gatsby component: [examples/client-side-routing](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/examples/client-side-routing)    
...
- Gatsby page shell: [pages/semantics.jsx](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/pages/semantics.jsx)
...
- [card-flip.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/components/better/card-flip.js)
...
- React: [examples/reduced-motion](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/examples/reduced-motion)
...
- Dropdown with Jest: [\__tests\__](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/src/components/better/__tests__)
...
- Jest test shell: [dropdown.test.js](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/src/components/better/__tests__/dropdown.test.js)
...
- Jest test: [dropdown.test.js](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/examples/unit-testing/dropdown.test.js)
...
[cypress/integration/index.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/cypress/integration/index.js)
...
- Cypress test shell: [index.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/cypress/integration/index.js)
...
- Cypress tests: [examples/integration-testing](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/examples/integration-testing)
