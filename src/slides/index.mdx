...
```shell
git clone https://github.com/marcysutton/gatsby-a11y-workshop.git
...
- React component shell: [dropdown.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/components/better/dropdown.js)
...
- React: [dropdown component](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/examples/dropdown/)
...
- React.js shell: [live-region](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/src/components/better/live-region.js)
...
- React component: [examples/live-region](https://github.com/marcysutton/gatsby-a11y-workshop/tree/master/examples/live-region)
...
- React component shell: [card-flip.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/components/better/card-flip.js)
...
- React component shell: [components/tab-list.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/components/better/tab-list.js)
...
- React component: [examples/tablist.js](https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/examples/progressive-enhancement)
