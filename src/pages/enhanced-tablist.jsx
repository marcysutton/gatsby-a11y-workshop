  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <p><strong>[<a href="https://github.com/marcysutton/gatsby-a11y-workshop/blob/master/src/components/better/enhancing-list.js">starter component source</a>]</strong></p>
        <EnhancingList items={[
            {id:0, label:'tab 1'},
            {id:1, label:'tab 2'}
        ]} />
